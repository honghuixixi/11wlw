...
import com.qpwa.foundation.CommonAttributes;
...
public final class SettingUtils {
	...
	public static Setting get() {
		...
		if (cacheElement != null) {
			...
			setting = new Setting();
			try {
				File qpwaXmlFile = new ClassPathResource(CommonAttributes.QPWA_XML_PATH).getFile();
				Document document = new SAXReader().read(qpwaXmlFile);
				List<Element> elements = document.selectNodes("/qpwa/setting");
	...
	public static void set(Setting setting) {
		try {
			...
			try {
				...
				fileOutputStream = new FileOutputStream(qpwaXmlFile);

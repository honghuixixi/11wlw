...
public class ExcelUtil {
	    ...
	    public boolean exportExcel(String fileName, String[] title, List<Map<String, Object>> dataList, String filePath)  
	        ...
	        try {  
	            ...
	            Label label;  
	            Field f;  
	            jxl.write.WritableFont wfcNav = new jxl.write
	            		.WritableFont(WritableFont.ARIAL, 15, WritableFont.NO_BOLD, false, UnderlineStyle.NO_UNDERLINE, jxl.format.Colour.BLACK);
